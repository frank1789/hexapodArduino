...
void UserCode(void)
{
	...
	ServoSetAll(2392,1500,1500,1500,1500,1500,1500,1500,2093,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 0
	delay(300);		//Default Delay

	//BEEP - Line # 1
	ServoSetAll(2392,1500,1500,1910,500,1500,1500,1500,2093,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 2
	delay(300);		//Default Delay
	delay(1000);
